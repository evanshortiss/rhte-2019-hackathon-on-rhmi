...
The remainder of the implemetation in Spring Boot is left as a task for you.

If you would like a more guided development experience, consider using the Node.js flow below.
