...
* An AMQ Streams instance with 2 topics - `{streams-traffic-topic-name}` and `{streams-meter-topic-name}`. These topics will be connected to a live stream of IoT data which needs to be ingested
